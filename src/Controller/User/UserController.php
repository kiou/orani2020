...
class UserController extends AbstractController
{
     ...
     * Réinitialisation
     */
    public function Reinitialisation(Request $request, TranslatorInterface $translator, MailerInterface $mailer)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $message = (new TemplatedEmail())
              ->from('pinelli.luc@hotmail.fr')
              ->to($form->getData()->getEmail())
              ->subject($translator->trans('reinitialisation.mail.title'))
              ->htmlTemplate('General/Mail/simple.html.twig') 
              ->context([
